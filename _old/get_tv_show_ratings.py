...
class get_tv_ratings(object):
    ...
    def get_rating_data(self):
        ...
        if current_season != season: #Primarily in odd case where the first season(s)
            #don't even have a page. See for example https://www.imdb.com/title/tt0042156/episodes
            self.averages=pd.DataFrame()
        else:
            seasons = []
